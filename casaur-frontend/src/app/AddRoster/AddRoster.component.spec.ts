...
import { AddRosterComponent } from './AddRoster.component';
...
describe('AddRosterComponent', () => {
  ...
  let mockAddRosterService;
  let mockDataService

  beforeEach(async(() => {

    mockAddRosterService = sinon.createStubInstance(AddRosterService);
    mockAddRosterService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: AddRosterService, useValue: mockAddRosterService },
