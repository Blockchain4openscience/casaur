...
import { PersonalCertificateHistoryComponent } from './PersonalCertificateHistory/PersonalCertificateHistory.component';
import { AdministratorHistoryComponent } from './AdministratorHistory/AdministratorHistory.component';
...
const routes: Routes = [
  ...
  { path: 'PersonalCertificateHistory', component: PersonalCertificateHistoryComponent },
  { path: 'AdministratorHistory', component: AdministratorHistoryComponent },
  { path: '**', redirectTo: '' }
];
